...
//        }
    ...
    @Before("execution (* com.example.UserService.service.JobService.*(..))")
    ...
    @After("execution (* com.example.UserService.service.JobService.*(..))")
    public void logMethodExecuted(JoinPoint jp) {
        LOGGER.info("Method Executed: " + jp.getSignature().getName());
    }

    @AfterThrowing("execution (* com.example.UserService.service.JobService.*(..))")
    public void logMethodCrashed(JoinPoint jp) {
        LOGGER.info("Method has some issues: " + jp.getSignature().getName());
    }

    @AfterReturning("execution (* com.example.UserService.service.JobService.*(..))")
